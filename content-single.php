	...
	<footer class="entry-footer">
		<?php
			...
			if ( ! foundation_s_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( 'This entry was tagged %2$s. Bookmark the <a href="%3$s" rel="bookmark">permalink</a>.', 'foundation-s' );
				} else {
					$meta_text = __( 'Bookmark the <a href="%3$s" rel="bookmark">permalink</a>.', 'foundation-s' );
				}
